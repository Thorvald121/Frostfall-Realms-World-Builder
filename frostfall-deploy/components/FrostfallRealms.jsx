...
const SEED_ARTICLES = [
  {
    id: "aerithel", title: "Aerithel the Dawnweaver", category: "deity",
    summary: "High Queen of the Ilonar, goddess of illumination, wisdom, foresight, and sacrifice.",
    temporal: { type: "immortal", active_start: -1000, active_end: null },
    fields: { domain: "Illumination, wisdom, foresight, sacrifice", symbol: "A golden sun with seven rays", court: "Ilonar (The Radiant Court)", sacred_time: "Dawn", worshippers: "Scholars, seers, rulers who bear heavy crowns", gift_to_mortals: "The ability to learn from the past and plan for the future" },
    body: "Aerithel sees far and understands the weight of time. She knows that all good things require loss, and she bears the sorrow of necessary sacrifice. She is kind but never soft, wise but burdened by knowledge.\n\nHer foresight makes her calculating. She will sacrifice the few for the many, and sometimes her \"greater good\" feels cold to those who suffer for it. Among all the @luminaeth and @umbraeth born powers, Aerithel alone understood the @first_law from the moment of her emergence.\n\nShe was one of three creators of the @alduinari, alongside @lyrandis and @nyraxis, pouring her essence into giving the High Elves long life, foresight, and the understanding of consequence.",
    tags: ["ilonar", "radiant-court", "creation", "sacrifice"],
    linkedIds: ["luminaeth", "alduinari", "lyrandis", "nyraxis", "first_law"],
    createdAt: "2026-02-08T14:23:00Z", updatedAt: "2026-02-09T09:11:00Z",
  },
  {
    id: "nyraxis", title: "Nyraxis the Veiled King", category: "deity",
    summary: "High King of the Khorvaeth, god of mystery, intuition, hidden knowledge, and the night.",
    temporal: { type: "immortal", active_start: -1000, active_end: null },
    fields: { domain: "Mystery, intuition, hidden knowledge, the night", symbol: "A crescent moon obscured by mist", court: "Khorvaeth (The Twilight Conclave)", sacred_time: "Midnight", worshippers: "Mystics, secret-keepers, those who walk in darkness", gift_to_mortals: "Intuition, dreams, and the wisdom to know what should stay hidden" },
    body: "Nyraxis knows that not all truths should be spoken and that some things must remain unknown. He is enigmatic and speaks in riddles, not from cruelty but because direct answers rob mortals of discovery.\n\nHis love of secrets means he sometimes withholds knowledge that could prevent suffering. Is mystery worth the cost of ignorance?\n\nTogether with @zevros, he secretly created the @drenathi in year 300, working in darkness to maintain balance. He also contributed to the creation of the @alduinari, giving them affinity for magic and comfort with the unknown.",
    tags: ["khorvaeth", "twilight-conclave", "mystery", "night"],
    linkedIds: ["zevros", "drenathi", "alduinari", "aerithel"],
    createdAt: "2026-02-08T15:01:00Z", updatedAt: "2026-02-09T08:45:00Z",
  },
  {
    id: "thorvaak", title: "Thorvaak the Wild Hunter", category: "deity",
    summary: "God of the hunt, predation, survival, strength, and wilderness.",
    temporal: { type: "immortal", active_start: -1000, active_end: null },
    fields: { domain: "The hunt, predation, survival, strength, wilderness", symbol: "A wolf's head with antlers", court: "Khorvaeth (The Twilight Conclave)", sacred_time: "The hunt (any time prey is pursued)", worshippers: "Hunters, trackers, survivalists, beast-masters", gift_to_mortals: "The instinct to survive and the strength to claim what is needed" },
    body: "Thorvaak embodies the brutal honesty of nature — eat or be eaten, adapt or perish. He respects strength and cunning. He is neither cruel nor kind; he simply is, like a storm or a beast.\n\nHe sees weakness as something to be culled. His \"mercy\" is a quick death. He cannot understand why mortals fight against natural selection.\n\nAlongside @vrenna, Thorvaak created the @urgath, imbuing them with strength, passion, and the survival instinct. He also contributed to the creation of the @kaelthari with @selindra and @kelthara.",
    tags: ["khorvaeth", "twilight-conclave", "wilderness", "survival"],
    linkedIds: ["vrenna", "urgath", "kaelthari", "selindra", "kelthara"],
    createdAt: "2026-02-07T20:30:00Z", updatedAt: "2026-02-08T11:20:00Z",
  },
  {
    id: "solvarin", title: "Solvarin the Wanderer", category: "deity",
    summary: "God of boundaries, thresholds, deals, travel, and trade. Neither light nor dark.",
    temporal: { type: "immortal", active_start: -1000, active_end: null },
    fields: { domain: "Boundaries, thresholds, deals, travel, trade", symbol: "A staff planted at a crossroads", court: "The In-Between (Morally Ambiguous)", sacred_time: "Crossroads moments, twilight", worshippers: "Merchants, travelers, diplomats, those who make pacts", gift_to_mortals: "The ability to bargain, trade, and honor agreements" },
    body: "Solvarin stands at every boundary — between light and dark, life and death, truth and lies. He honors all bargains equally and cares nothing for morality, only for the terms agreed upon.\n\nHe will enforce an unjust contract as readily as a just one. A deal is a deal. He is perfectly neutral, which makes him perfectly dangerous.\n\nUniquely among the gods, Solvarin alone created humanity as an experiment in adaptability and balance. Humans appeared not in one place but many — small groups awakening across @aelvarin simultaneously.",
    tags: ["in-between", "neutral", "bargains", "creation"],
    linkedIds: ["aelvarin", "myrreth", "koranis"],
    createdAt: "2026-02-06T10:15:00Z", updatedAt: "2026-02-09T07:30:00Z",
  },
  {
    id: "alduinari", title: "The Alduinari (High Elves)", category: "race",
    summary: "The First Making — beings of wisdom, beauty, and mystery created by three gods working in concert.",
    temporal: { type: "race", active_start: 0, active_end: null },
    fields: { creators: "Aerithel, Lyrandis, Nyraxis", lifespan: "800–1,200 years", population: "~80,000 at peak (declining)", magic_affinity: "High (but the First Law's cost is still paid)", homeland: "Forest kingdoms, towers of learning, twilight courts", capital: "Aer'thelas (Star-Crown)" },
    body: "The Alduinari were the first and most ambitious creation — beings who embodied the best of both Ilonar and Khorvaeth working together. From @aerithel they received long lives and foresight; from @lyrandis, an innate connection to language, music, and art; from @nyraxis, affinity for magic and the mysterious.\n\nThe first to awaken, Aelorin the Dawn-Touched, spoke the Three Utterances: \"Ëni kenaë. Ëni istayë. Ëni naë.\" (I see. I know. I am.)\n\nBut the Alduinari were made too well. Their long lives led to a slow birth rate. Their perfect memories make them struggle to let go of the past. Their foresight often paralyzes them. They are noble but distant, wise but proud, beautiful but lonely — shepherds of the world who have begun to fade from it.\n\nThey built the first city, Aer'thelas (Star-Crown), and later the Silver Library of Lúminas and the Tower of Stars at Sílanost. They played a crucial role in @dragon_crisis and the sealing of @the_sundering.",
    tags: ["first-making", "elves", "magic", "fading"],
    linkedIds: ["aerithel", "lyrandis", "nyraxis", "kaelthari", "dragon_crisis", "the_sundering"],
    createdAt: "2026-02-05T09:00:00Z", updatedAt: "2026-02-09T10:45:00Z",
  },
  {
    id: "urgath", title: "The Urgath (Orcs)", category: "race",
    summary: "The Fourth Making — born during a thunderstorm, embodying freedom, strength, and the joy of living fully.",
    temporal: { type: "race", active_start: 700, active_end: null },
    fields: { creators: "Thorvaak the Wild Hunter, Vrenna the Tempest-Voice", lifespan: "60–80 years", population: "~1,500,000 (growing)", magic_affinity: "Low-moderate (war-shamans channel primal forces)", homeland: "Open steppes, nomadic territories", major_clans: "Stormborn, Ironjaw, Bloodthunder" },
    body: "The orcs awoke during a thunderstorm on the open steppes, and their first act was to roar back at the thunder. Created by @thorvaak and @vrenna, the Urgath were born understanding freedom, strength, and the joy of living fully.\n\nGrom Stormsoul became the first war-chief by defeating a territorial bear with bare hands. The orcs celebrated for seven days and nights.\n\nBy the Third Age, the Urgath face an internal crisis: \"Old Way\" nomadic traditionalists versus \"New Way\" orcs building the first permanent settlements. Some clans declared humans \"cursed\" after @the_sundering and refuse all contact.",
    tags: ["fourth-making", "orcs", "nomadic", "strength"],
    linkedIds: ["thorvaak", "vrenna", "the_sundering", "dragon_crisis", "kaelthari"],
    createdAt: "2026-02-06T14:20:00Z", updatedAt: "2026-02-08T16:00:00Z",
  },
  {
    id: "kharador", title: "The Kharador (Dwarves)", category: "race",
    summary: "The Third Making — carved into consciousness within Karak Thrum, born knowing the weight of stone.",
    temporal: { type: "race", active_start: 500, active_end: null },
    fields: { creators: "Thalric the Forge-Father, Kelthara the Whispering Root", lifespan: "300–500 years", population: "~800,000", magic_affinity: "Moderate (rune magic)", homeland: "Mountain holds (twelve great holds at peak)", capital: "Karak Thrum (Stone of Ancestors)" },
    body: "The dwarves did not awaken — they were carved into consciousness deep within the mountain of Karak Thrum. They emerged from the rock itself, already knowing the weight of stone and the patience of earth.\n\nThorgrim Ironheart struck the first blow upon the first anvil, creating the Stakul Primus (First Steel) — a hammer that still rests in Karak Thrum's Hall of Making.\n\nCreated by @thalric and @kelthara, the Kharador embody endurance and connection to the deep earth. Three holds were destroyed during @dragon_crisis, and two runepriests gave their lives sealing @the_sundering.",
    tags: ["third-making", "dwarves", "stone", "crafting"],
    linkedIds: ["dragon_crisis", "the_sundering", "alduinari"],
    createdAt: "2026-02-05T11:30:00Z", updatedAt: "2026-02-09T06:15:00Z",
  },
  {
    id: "veylthari", title: "The Veylthari (Witness-Kin)", category: "race",
    summary: "Eerie multi-eyed beings from the Shrouded Reaches, created by the Thousand-Eyed Observer to witness and record all things.",
    temporal: { type: "race", active_start: -500, active_end: null },
    fields: { creators: "The Thousand-Eyed Observer (unknown entity)", lifespan: "2,000+ years (no visible aging)", population: "~15,000–25,000 (estimated)", magic_affinity: "Unique (perception-based)", homeland: "The Shrouded Reaches — Mirror Cities", defining_trait: "3–8 independently moving eyes per individual" },
    body: "Every Veylthari has 3–8 total eyes, each seeing different spectrums of reality. Their primary eyes see through illusions; additional eyes perceive magic, detect lies, see spirits, and read emotional states.\n\nThey exist to witness and record — everything else is secondary. Their society is divided into Chroniclers (4+ eyes, highest status), Watchers (2–3 extra eyes), and the Unseeing (1 extra eye, considered failures).\n\nThe curse of perfect memory drives ~30% mad by age 500. The illegal Forgetting Ritual is secretly practiced despite being punishable by death.",
    tags: ["shrouded-reaches", "witness", "memory", "outsider"],
    linkedIds: ["aelvarin"],
    createdAt: "2026-02-07T19:45:00Z", updatedAt: "2026-02-09T11:00:00Z",
  },
  {
    id: "dragon_crisis", title: "The Dragon Crisis", category: "event",
    summary: "The First Great War (Year 1,200–1,337) — when ancient wyrms claimed Aelvarin and all races united to survive.",
    temporal: { type: "event", active_start: 1200, active_end: 1337 },
    fields: { date_range: "Year 1,200 – 1,337 (137 years)", age: "Second Age (Age of Kingdoms)", casualties: "~1,200,000 across all races", key_figures: "Valthrakkor the Ash-King, Thessara Moonwhisper, Queen Elara of Korvanthia, Thane-King Haldrek Stonefist, War-Chief Urgoth Dragonbreaker", outcome: "Dragon defeat at Dragonfall Peak; formation of the Council of Covenant" },
    body: "Something stirred in the deep places of the world. Ancient creatures, older than the mortal races — Dragons. Not created by the gods but born from the Weaving itself, they were primordial and powerful.\n\nThe eldest, Valthrakkor the Ash-King, emerged from volcanic mountains and claimed all of @aelvarin as his domain. Over 500,000 died before the races could respond.\n\nDesperation forced cooperation. At the Covenant Stone, representatives of all races — @alduinari, @kaelthari, humans, @kharador, and @urgath — formed the First Covenant.\n\nValthrakkor fell at Dragonfall Peak. But at terrible cost: three dwarven holds destroyed, dozens of human cities gone, vast forests burned, orcish clans reduced by half.",
    tags: ["war", "dragons", "covenant", "second-age"],
    linkedIds: ["alduinari", "kharador", "urgath", "the_sundering", "aelvarin"],
    createdAt: "2026-02-06T08:00:00Z", updatedAt: "2026-02-09T09:30:00Z",
  },
  {
    id: "the_sundering", title: "The Sundering", category: "event",
    summary: "The greatest catastrophe since the Dragon Wars (Year 2,800–2,817) — when human mages tore the fabric of reality.",
    temporal: { type: "event", active_start: 2800, active_end: 2817 },
    fields: { date_range: "Year 2,800 – 2,817 (17 years)", age: "Second Age → Third Age transition", casualties: "~3,200,000 (mostly human)", key_figures: "The mages of Mordrath, The Twelve Who Fell", outcome: "Rift sealed at terrible cost; Mordrath erased; Accords of Binding established" },
    body: "Human mages in the kingdom of Mordrath sought power beyond what the @first_law allowed — magic without cost, drawing directly from the Weaving itself. For a moment, it worked. Then the Weaving began to tear.\n\nA massive rift in reality opened above Mordrath. Void energy poured through — not darkness, but absence. The kingdom of Mordrath (population 2 million) was erased in nine days.\n\nThe @alduinari seers warned: if unsealed, the rift would consume all of @aelvarin within a decade. The Twelve Who Fell — 3 Alduinari archmages, 2 Kaelthari shamans, 3 human wizards, 2 @kharador runepriests, 2 @urgath war-shamans — walked into the rift. Their life-force re-wove reality.",
    tags: ["catastrophe", "void", "magic", "sacrifice", "age-transition"],
    linkedIds: ["first_law", "alduinari", "kharador", "urgath", "aelvarin"],
    createdAt: "2026-02-05T16:00:00Z", updatedAt: "2026-02-09T10:00:00Z",
  },
  {
    id: "siege_of_voidwaste", title: "The Siege of the Voidwaste", category: "event",
    summary: "A controversial Third Age campaign where allied forces attempted to reclaim the dead zone left by the Sundering.",
    temporal: { type: "event", active_start: 4200, active_end: 4205 },
    fields: { date_range: "Year 4,200 – 4,205", age: "Third Age (Age of Division)", casualties: "~45,000", key_figures: "Queen Elara of Korvanthia, Thorgrim Ironheart, War-Chief Urgoth Dragonbreaker", outcome: "Failed — the Voidwaste could not be reclaimed" },
    body: "In the depths of the Third Age, a coalition of the desperate attempted what many considered madness — to reclaim the Voidwaste. @queen_elara rallied Korvanthia's armies while @thorgrim_ironheart brought dwarven siege engines from @kharador holds.\n\n@urgoth_dragonbreaker led the Urgath vanguard, his @urgath warriors charging into the dead zone with characteristic fearlessness. The campaign lasted five brutal years.\n\nThe Voidwaste resisted all efforts to heal it. The @first_law could not be undone — what was erased during @the_sundering was gone forever.",
    tags: ["third-age", "voidwaste", "failed-campaign"],
    linkedIds: ["queen_elara", "thorgrim_ironheart", "urgoth_dragonbreaker", "kharador", "urgath", "first_law", "the_sundering"],
    createdAt: "2026-02-09T12:00:00Z", updatedAt: "2026-02-09T12:30:00Z",
  },
  // === CHARACTERS (migrated from race) ===
  {
    id: "queen_elara", title: "Queen Elara of Korvanthia", category: "character",
    summary: "Human queen who united Korvanthia during the Dragon Crisis and led the human contingent at the Covenant Stone.",
    temporal: { type: "mortal", active_start: 1180, active_end: 1290, birth_year: 1180, death_year: 1290 },
    fields: { char_race: "Human", birth_year: "1180", death_year: "1290", titles: "Queen of Korvanthia, The Brave", affiliations: "Korvanthia, Council of Covenant", role: "Ruler who rallied human kingdoms during the Dragon Crisis" },
    body: "Queen Elara was among the greatest human rulers in the history of @aelvarin. She rallied the fractured human kingdoms during @dragon_crisis and personally stood at the Covenant Stone alongside @alduinari and @kharador representatives.\n\nShe reigned for 60 years and died peacefully at the age of 110. Her dynasty continued for three more centuries before the Sundering ended Korvanthia's golden age.",
    tags: ["human", "queen", "korvanthia", "dragon-crisis", "covenant"],
    linkedIds: ["aelvarin", "dragon_crisis", "alduinari", "kharador"],
    createdAt: "2026-02-07T10:00:00Z", updatedAt: "2026-02-09T10:00:00Z",
  },
  {
    id: "thorgrim_ironheart", title: "Thorgrim Ironheart", category: "character",
    summary: "The legendary first dwarf who struck the Stakul Primus and founded Kharador civilization.",
    temporal: { type: "mortal", active_start: 500, active_end: 950, birth_year: 500, death_year: 950 },
    fields: { char_race: "Kharador (Dwarf)", birth_year: "500", death_year: "950", titles: "First Smith, Father of the Kharador", affiliations: "Karak Thrum", role: "First dwarf, founder of Kharador civilization" },
    body: "Thorgrim Ironheart was the first dwarf to achieve consciousness, carved from the living rock of Karak Thrum by @thalric and @kelthara. He struck the first blow upon the first anvil, creating the Stakul Primus (First Steel).\n\nHe led the @kharador through their earliest centuries, establishing the first three great holds. He died at the venerable age of 450, centuries before @dragon_crisis — but his hammer and his legacy endure.",
    tags: ["dwarf", "kharador", "founder", "first-making"],
    linkedIds: ["kharador", "dragon_crisis"],
    createdAt: "2026-02-07T11:00:00Z", updatedAt: "2026-02-09T10:15:00Z",
  },
  {
    id: "urgoth_dragonbreaker", title: "War-Chief Urgoth Dragonbreaker", category: "character",
    summary: "The legendary Urgath war-chief who led orcish forces during the Dragon Crisis.",
    temporal: { type: "mortal", active_start: 1220, active_end: 1340, birth_year: 1220, death_year: 1340 },
    fields: { char_race: "Urgath (Orc)", birth_year: "1220", death_year: "1340", titles: "War-Chief, Dragonbreaker", affiliations: "Stormborn clan, Ironjaw clan, Bloodthunder clan", role: "United orcish clans during the Dragon Crisis; slew Valthrakkor" },
    body: "Urgoth earned the name \"Dragonbreaker\" at the final battle of @dragon_crisis when he personally hamstrung Valthrakkor the Ash-King.\n\nHe was the greatest of all @urgath war-chiefs, uniting the Stormborn, Ironjaw, and Bloodthunder clans under a single banner for the first time. He died three years after the war ended.",
    tags: ["orc", "urgath", "war-chief", "dragon-crisis", "hero"],
    linkedIds: ["dragon_crisis", "urgath"],
    createdAt: "2026-02-07T12:00:00Z", updatedAt: "2026-02-09T10:30:00Z",
  },
  // === MAGIC / LORE ===
  {
    id: "first_law", title: "The First Law", category: "magic",
    summary: "The foundational truth of Aelvarin: creation requires sacrifice. Magic demands the caster surrender something of themselves.",
    temporal: { type: "concept", active_start: -10000, active_end: null },
    fields: { type: "Fundamental Law of Reality", origin: "Discovered during the Weaving by Luminaeth and Umbraeth", scope: "Universal — applies to all magic, divine and mortal", cost_types: "Life force, vitality, memory, years of life", violation_consequence: "Reality fractures (see: The Sundering)" },
    body: "The Weaving revealed a terrible truth that would define all of @aelvarin:\n\nCreation requires sacrifice. To give form costs essence. To work change demands a price.\n\nThis became the First Law, woven into the very fabric of reality. @luminaeth and @umbraeth learned this as they wove, for with each act of creation, they diminished.\n\nThe catastrophic violation of the First Law by human mages led directly to @the_sundering — proof that reality itself enforces this truth.",
    tags: ["fundamental", "magic-system", "weaving", "sacrifice"],
    linkedIds: ["aelvarin", "the_sundering", "luminaeth", "umbraeth"],
    createdAt: "2026-02-04T12:00:00Z", updatedAt: "2026-02-09T08:00:00Z",
  },
  {
    id: "luminaeth", title: "Luminaeth (The Ascending Flame)", category: "magic",
    summary: "One of the Twin Powers — the principle of form, order, consciousness, and illumination.",
    temporal: { type: "immortal", active_start: -10000, active_end: -500, faded: true },
    fields: { type: "Primordial Force / Faded Twin Power", origin: "Emerged from the First Breath of Aelos", counterpart: "Umbraeth (The Returning Deep)", current_state: "Faded — now a principle rather than a conscious being", legacy: "Created the Ilonar (Radiant Court)" },
    body: "From the First Breath of Aelos emerged two fundamental forces. Luminaeth — the Ascending Flame — burned with the desire to create patterns, to crystallize the infinite into the knowable.\n\nTogether with @umbraeth they created @aelvarin itself. But the @first_law took its toll: with each act of creation, Luminaeth diminished.\n\nFrom Luminaeth's essence came the Ilonar — including @aerithel, Thalric, Selindra, Valorim, and @lyrandis.",
    tags: ["twin-powers", "primordial", "light", "creation"],
    linkedIds: ["umbraeth", "aelvarin", "first_law", "aerithel", "lyrandis"],
    createdAt: "2026-02-04T11:00:00Z", updatedAt: "2026-02-08T14:00:00Z",
  },
  {
    id: "umbraeth", title: "Umbraeth (The Returning Deep)", category: "magic",
    summary: "The other Twin Power — principle of dissolution, change, instinct, and shadow.",
    temporal: { type: "immortal", active_start: -10000, active_end: -500, faded: true },
    fields: { type: "Primordial Force / Faded Twin Power", counterpart: "Luminaeth (The Ascending Flame)", current_state: "Faded", legacy: "Created the Khorvaeth (Twilight Conclave)" },
    body: "The Returning Deep — Umbraeth flowed with the need to preserve mystery, to return all things eventually to the potential from which they came. Together with @luminaeth, Umbraeth wove reality itself and created @aelvarin.",
    tags: ["twin-powers", "primordial", "shadow", "dissolution"],
    linkedIds: ["luminaeth", "aelvarin", "first_law", "nyraxis", "thorvaak"],
    createdAt: "2026-02-04T11:05:00Z", updatedAt: "2026-02-08T14:05:00Z",
  },
  {
    id: "aelvarin", title: "Aelvarin — The World-Continent", category: "magic",
    summary: "The world itself — a vast landmass floating in an endless sea, born from the Twin Powers.",
    temporal: { type: "concept", active_start: -10000, active_end: null },
    fields: { type: "World / Setting", origin: "Created by Luminaeth and Umbraeth", current_age: "Third Age (Age of Division)", notable_regions: "Korvanthia, Nordgard, Solmaren, The Voidwaste, Shrouded Reaches" },
    body: "From the greatest collaborative effort of @luminaeth and @umbraeth came Aelvarin — the world-continent, a vast landmass floating in an endless sea.\n\nAt the edges of the world exist the Shrouded Reaches — strange half-formed lands, home to the @veylthari.",
    tags: ["world", "setting", "geography"],
    linkedIds: ["luminaeth", "umbraeth", "veylthari", "first_law", "the_sundering"],
    createdAt: "2026-02-04T10:00:00Z", updatedAt: "2026-02-09T11:30:00Z",
  },
];
  ...
  const parseDocumentWithAI = async (text, filename) => {
    ...
    try {
      ...
      const staged = entries.map((e, i) => ({
        ...
        _status: "pending", // pending | approved | rejected | edited
