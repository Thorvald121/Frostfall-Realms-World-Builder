...
// All 17 tokens per theme. Used by FrostfallRealms.jsx, ThemeSelect.jsx, and themes.css.
...
export const THEMES = {
  ...
  parchment: {
    ...
    inputBg: "#faf6f0",
    topBarBg: "rgba(245,240,232,0.96)",
    cardBg: "rgba(236,228,212,0.6)",
  },

  frostfall_ice: {
    name: "Frostfall Ice",
    desc: "Glacier blues, cold steel accents",
    ...
    inputBg: "#06121f",
    topBarBg: "rgba(6,18,31,0.95)",
    cardBg: "rgba(10,27,45,0.62)",
  },

  emberforge: {
    name: "Emberforge",
    desc: "Charcoal + ember orange, forge-lit UI",
